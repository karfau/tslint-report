...
export const DEPRECATED: 'Deprecated' = 'Deprecated';

/**
 * Ignored - Use this value to exclude the rule from recommended_ruleset.js
 * and the deployed tslint.json file.
 */
export type Group = 'Ignored' | 'Security' | 'Correctness' | 'Accessibility' | 'Clarity' |
  'Whitespace' | 'Configurable' | typeof DEPRECATED;
